...
@section('title', 'Tambah Obat - Formularium')
    ...
    <div class="col-lg-10">
        <div class="card shadow">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-pills me-2"></i>Form Tambah Obat
                </h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('therapy_class') is-invalid @enderror" 
                                           id="therapy_class" name="therapy_class" value="{{ old('therapy_class') }}">
                                    @error('therapy_class')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('sub_therapy_class') is-invalid @enderror" 
                                           id="sub_therapy_class" name="sub_therapy_class" value="{{ old('sub_therapy_class') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                        ...
                                        <option value="Antiseptik" {{ old('category') == 'Antiseptik' ? 'selected' : '' }}>Antiseptik</option>
                                        <option value="Antihistamin" {{ old('category') == 'Antihistamin' ? 'selected' : '' }}>Antihistamin</option>
                                        <option value="Antasida" {{ old('category') == 'Antasida' ? 'selected' : '' }}>Antasida</option>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('dosage_form') is-invalid @enderror" id="dosage_form" name="dosage_form" required>
                                        ...
                                        <option value="Injeksi" {{ old('dosage_form') == 'Injeksi' ? 'selected' : '' }}>Injeksi</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('peresepan_maksimal') is-invalid @enderror" 
                                           id="peresepan_maksimal" name="peresepan_maksimal" value="{{ old('peresepan_maksimal') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('restriksi_kelas_terapi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('restriksi_kelas_terapi') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi umum tentang obat ini...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('indications') is-invalid @enderror" 
                                          ...
                                          placeholder="Untuk apa obat ini digunakan...">{{ old('indications') }}</textarea>
                                @error('indications')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('contraindications') is-invalid @enderror" 
                                          ...
                                          placeholder="Kondisi yang tidak boleh menggunakan obat ini...">{{ old('contraindications') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('side_effects') is-invalid @enderror" 
                                          ...
                                          placeholder="Efek samping yang mungkin terjadi...">{{ old('side_effects') }}</textarea>
                                @error('side_effects')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('dosage_instructions') is-invalid @enderror" 
                                          ...
                                          placeholder="Cara penggunaan obat...">{{ old('dosage_instructions') }}</textarea>
